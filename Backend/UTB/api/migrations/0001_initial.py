# Generated by Django 6.0 on 2025-12-24 19:54
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('artist', 'Artist'), ('distributor', 'Distributor'), ('user', 'User')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(blank=True, null=True, upload_to='artworks/')),
                ('cover_image', models.ImageField(blank=True, null=True, upload_to='covers/')),
                ('royalty_percentage', models.PositiveIntegerField()),
                ('artist', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='created_art', to=settings.AUTH_USER_MODEL)),
                ('owner', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='owned_art', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Listing',
